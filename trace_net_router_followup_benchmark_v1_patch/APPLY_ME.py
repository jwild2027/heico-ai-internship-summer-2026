...
copy_files = [
    ...
    "scripts/run_trace_net_router_followup_retrieval_benchmark_v1.py",
...
target = repo / "scripts/serve_trace_net_openwebui_unified_rag_v2.py"
...
print("updated scripts/serve_trace_net_openwebui_unified_rag_v2.py")
