...
def validate_required_files(args: argparse.Namespace) -> None:
    ensure_script("scripts/serve_trace_net_e2e_local_endpoint_v1.py")
    ensure_script("scripts/serve_trace_net_guided_discovery_router_proxy_v6.py")
    ensure_script("scripts/serve_trace_net_router_proxy_v6_gemma_visual_v1.py")
