...
FILES = [
    ("scripts/serve_trace_net_guided_discovery_router_proxy_v4.py", "scripts/serve_trace_net_guided_discovery_router_proxy_v4.py"),
    ("scripts/launch_trace_net_router_stack_v2.py", "scripts/launch_trace_net_router_stack_v2.py"),
