...
from tiff.trace_net_e2e_live_relationship_synthesis_planner_v29 import load_state_for_serving, serve


def main() -> int:
    parser = argparse.ArgumentParser(description="Serve TRACE-Net live relationship/synthesis planner v29")
    parser.add_argument("--live-relationship-synthesis-planner", required=True)
    ...
    state = load_state_for_serving(Path(args.live_relationship_synthesis_planner))
    ...
    state["relationship_mode"] = args.relationship_mode
