...
def build_commands(args: argparse.Namespace) -> Dict[str, List[str]]:
    py = sys.executable
    normal = [
        py, "-B", "scripts/operations/serving/serve_trace_net_live_rag_normal_v2.py",
    ...
    guided = [
        py, "-B", "scripts/operations/serving/serve_trace_net_guided_candidate_discovery_endpoint_v1.py",
    ...
    unified = [
        py, "-B", "scripts/operations/s6_retrieval/serve_trace_net_openwebui_unified_rag_v2.py",
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    for path in (
        ...
        "scripts/operations/serving/serve_trace_net_live_rag_normal_v2.py",
        "scripts/operations/serving/serve_trace_net_guided_candidate_discovery_endpoint_v1.py",
        "scripts/operations/s6_retrieval/serve_trace_net_openwebui_unified_rag_v2.py",
    ):
        ensure(path)
