...
for required in \
  ...
  scripts/maintenance/s6_retrieval/check_trace_net_h30_claim_ready_evidence_v1.py \
...
for public_answer_required in \
  ...
  scripts/benchmark/writing/check_trace_net_h30_public_answer_golden_v1.py \
...
for final_required in \
  ...
  scripts/maintenance/validation/check_trace_net_h30_final_engram_rollout_v1.py \
  scripts/benchmark/run_trace_net_h30_final_rollout_live_smoke_v1.py \
  scripts/benchmark/validation/run_trace_net_h30_final_engram_benchmark_v1.py; do
...
"$PYTHON" -m py_compile \
  ...
  src/trace_net/router/trace_net_h30_shadow_planner_v1.py \
  src/trace_net/engram/trace_net_h30_engram_skill_planner_guidance_v1.py \
  scripts/maintenance/s5_engram/check_trace_net_engram_skill_planner_guidance_v1.py \
  scripts/benchmark/run_trace_net_engram_skill_planner_guidance_live_smoke_v1.py \
  src/trace_net/context/trace_net_h30_typed_evidence_envelope_v1.py \
  scripts/maintenance/s6_retrieval/check_trace_net_h30_typed_evidence_envelope_v1.py \
  src/trace_net/context/trace_net_h30_claim_ready_evidence_v1.py \
  scripts/maintenance/s6_retrieval/check_trace_net_h30_claim_ready_evidence_v1.py \
  src/trace_net/writing/trace_net_h30_content_reconstruction_v1.py \
  scripts/maintenance/writing/check_trace_net_h30_content_reconstruction_v1.py \
  ...
  scripts/maintenance/writing/check_trace_net_h30_evidence_aware_answer_modes_v1.py \
  scripts/benchmark/run_trace_net_h30_evidence_aware_answer_modes_live_smoke_v1.py \
  scripts/maintenance/s6_retrieval/check_trace_net_h30_shadow_planner_v1.py \
...
"$PYTHON" -m py_compile \
  ...
  scripts/maintenance/validation/check_trace_net_h30_final_engram_rollout_v1.py \
  scripts/benchmark/run_trace_net_h30_final_rollout_live_smoke_v1.py \
  scripts/benchmark/validation/run_trace_net_h30_final_engram_benchmark_v1.py
...
exec "$PYTHON" -u -B scripts/operations/s6_retrieval/serve_trace_net_cognitive_router_v1.py \\
  --host 127.0.0.1 \\
  --port 8118 \\
...
export TRACE_NET_H30_CONSTRAINED_WRITER_MANDATORY_TECHNICAL_ROUTES="$CONSTRAINED_WRITER_MANDATORY_TECHNICAL_ROUTES"
...
exec "$PYTHON" -u -B scripts/operations/writing/serve_trace_net_full_gemma_cognitive_v1.py \\
  --host 127.0.0.1 \\
  --port 8128 \\
