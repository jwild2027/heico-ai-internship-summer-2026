...
def _print_summary(summary) -> None:
    ...
    print(f"  python scripts/maintenance/s2_ocr/audit_ocr_depth.py --export-dir {summary.output_dir} --write-json --json-output local_data/ocr/ocr_pilot_depth_audit.json")
