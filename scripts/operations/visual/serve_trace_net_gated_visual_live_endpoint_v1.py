...
MODULE_NAME = "trace_net_gated_visual_live_endpoint_v1"
...
class VisualEndpoint:
    ...
    def chat_response(self, body: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            "id": "trace-net-gated-visual-live-endpoint-v1",
            "object": "chat.completion",
            "model": body.get("model") or "trace-net-gated-visual-live-endpoint-v1",
            "choices": [
                {
                    "index": 0,
                    "message": {
