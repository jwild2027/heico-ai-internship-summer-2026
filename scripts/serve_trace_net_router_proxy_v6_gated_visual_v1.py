...
MODULE_NAME = "trace_net_router_proxy_v6_gated_visual_v1"
STATUS_READY = "TRACE_NET_ROUTER_PROXY_V6_GATED_VISUAL_V1_READY"
STATUS_DONE = "TRACE_NET_ROUTER_PROXY_V6_GATED_VISUAL_V1_DONE"
QUALITY_PASS = "PASS"
QUALITY_WARN = "WARN"
QUALITY_FAIL = "FAIL"

DEFAULT_MODEL = "trace-net-router-proxy-v6-gated-visual-v1"
...
visual_live = _load_sibling_module(
    "trace_net_gated_visual_live_endpoint_v1_module",
    "serve_trace_net_gated_visual_live_endpoint_v1.py",
)
...
def route_payload(payload: Dict[str, Any], config: CompositeConfig) -> Dict[str, Any]:
    ...
    use_visual_first = config.visual_route_first and not base_mode_forced(payload)
...
class CompositeRouterHandler(BaseHTTPRequestHandler):
    server_version = "TraceNetRouterProxyV6GatedVisualV1/1.0"
