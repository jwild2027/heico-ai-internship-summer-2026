...
def main() -> int:
    ap = argparse.ArgumentParser(description="Check TRACE-Net E2E Image Visual Observer Route v34 quality")
    ...
    print("TRACE-Net E2E Image Visual Observer Route v34 Quality")
