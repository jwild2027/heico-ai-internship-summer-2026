...
def main() -> int:
    ap = argparse.ArgumentParser(description="Check TRACE-Net E2E Image Visual Observer Route v34.1 quality")
    ...
    print("TRACE-Net E2E Image Visual Observer Route v34.1 Quality")
