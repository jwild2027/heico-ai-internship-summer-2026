...
Usage:
    python scripts/maintenance/ingestion/inventory_tiffs.py --dir "C:/path/to/tiffs" --db-path rag.db
    python scripts/maintenance/ingestion/inventory_tiffs.py --dir "C:/path/to/tiffs" --db-path rag.db --limit 100 --no-hash
"""
