...
def main() -> int:
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="Fail unless scripts/operations/ingestion/run_user_query_tests.py results are present and all passing.",
    )
    parser.add_argument(
        "--require-realistic-query-trace",
        action="store_true",
        help="Fail unless scripts/operations/ingestion/run_realistic_query_trace_tests.py results are present and all passing.",
    )
    parser.add_argument(
