...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build TRACE-Net live deterministic answer planner + drilldown v28")
    ...
    print("TRACE-Net E2E Live Deterministic Answer Planner + Drilldown v28")
