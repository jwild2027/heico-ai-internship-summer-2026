...
shadow = (ROOT / "scripts/trace_net_h30_shadow_planner_v1.py").read_text(encoding="utf-8")
benchmark = (ROOT / "scripts/run_trace_net_h30_shadow_planner_benchmark_v1.py").read_text(encoding="utf-8")
required = {
