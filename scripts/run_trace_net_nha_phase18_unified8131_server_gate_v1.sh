...
rollback_on_failure() {
  status=$?
  bash scripts/launch_trace_net_cognitive_openwebui_nha_unified_v1.sh rollback || true
  exit "$status"
}
...
echo "legacy_8131_rollback_command=bash scripts/launch_trace_net_cognitive_openwebui_nha_unified_v1.sh rollback"
