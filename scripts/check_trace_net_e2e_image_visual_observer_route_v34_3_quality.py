...
def main() -> int:
    ap = argparse.ArgumentParser(description="Check TRACE-Net E2E Image Visual Observer + Technical Drawing Geometry Route v34.3 quality")
    ...
    print("TRACE-Net E2E Image Visual Observer + Technical Drawing Geometry Route v34.3 Quality")
