...
cleanup_failed_candidate() {
  ...
  if [[ "$PROMOTED" == "0" ]]; then
    TRACE_NET_BLUE_GREEN_ALLOW_STOP_ACTIVE=0 \
      bash scripts/launch_trace_net_nha_blue_green_candidate_v1.sh "$COLOR" stop || true
  fi
...
for required in \
  ...
  scripts/serve_trace_net_blue_green_frontdoor_v1.py \
  scripts/launch_trace_net_nha_blue_green_candidate_v1.sh \
  scripts/promote_trace_net_nha_blue_green_v1.sh \
  scripts/serve_trace_net_nha_phase20_gemma100_v1.py \
  scripts/run_trace_net_nha_phase20_gemma100_v1.py \
  scripts/check_trace_net_nha_phase20_gemma100_v1.py; do
...
bash scripts/launch_trace_net_nha_blue_green_candidate_v1.sh "$COLOR" start
...
"$PYTHON" -B scripts/run_trace_net_nha_phase18_unified8131_gate_v1.py \
...
"$PYTHON" -B scripts/check_trace_net_nha_phase18_unified8131_gate_v1.py \
  --output-dir "$RUN_ROOT/mixed12" \
  --strict
...
bash scripts/promote_trace_net_nha_blue_green_v1.sh "$COLOR"
PROMOTED=1
