...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build TRACE-Net live relationship/synthesis planner v29")
    ...
    parser.add_argument("--relationship-mode", default="guarded", choices=["guarded"])
    ...
    state = build_state(
        ...
        relationship_mode_setting=args.relationship_mode,
    ...
    print("TRACE-Net E2E Live Relationship/Synthesis Planner v29")
