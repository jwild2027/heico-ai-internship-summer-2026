...
from tiff.trace_net_e2e_image_visual_observer_route_v34_3 import build_report


def main() -> int:
    ap = argparse.ArgumentParser(description="Build TRACE-Net E2E Image Visual Observer + Technical Drawing Geometry Route v34.3")
    ...
    ap.add_argument("--min-technical-drawing-candidates", type=int, default=0)
    ap.add_argument("--min-technical-drawing-feature-cards", type=int, default=0)
    ...
    from tiff.trace_net_e2e_image_visual_observer_route_v34_3 import evaluate_quality, _write_json
    ...
    checks = evaluate_quality(
        ...
        min_technical_drawing_candidates=args.min_technical_drawing_candidates,
        min_technical_drawing_feature_cards=args.min_technical_drawing_feature_cards,
    ...
    print("TRACE-Net E2E Image Visual Observer + Technical Drawing Geometry Route v34.3")
