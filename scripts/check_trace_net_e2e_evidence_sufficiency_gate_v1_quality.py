...
from tiff.trace_net_e2e_evidence_sufficiency_gate_v1 import QUALITY_PASS, _write_json, evaluate_quality
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Check TRACE-Net E2E evidence sufficiency gate quality.")
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    if args.write_json:
        ...
        quality_path = args.report_path.with_name("trace_net_e2e_evidence_sufficiency_gate_v1_quality.json")
        _write_json(quality_path, {"quality_status": quality_status, "quality_checks": checks, "summary": report.get("summary", {})})
    print("TRACE-Net E2E Evidence Sufficiency Gate v1 Quality")
