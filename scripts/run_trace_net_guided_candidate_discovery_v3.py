...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="TRACE-Net guided candidate discovery v3")
    ...
    # Kept for CLI continuity with v1. v3 source-of-truth output is deterministic JSON/view.
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    summary = {
        "status": "TRACE_NET_GUIDED_CANDIDATE_DISCOVERY_V3_DONE",
