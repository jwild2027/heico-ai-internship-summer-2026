...
for required in \
  ...
  scripts/benchmark/serving/serve_trace_net_nha_phase20_gemma100_v1.py \
  scripts/benchmark/graph/run_trace_net_nha_phase20_gemma100_v1.py \
  scripts/benchmark/graph/check_trace_net_nha_phase20_gemma100_v1.py; do
...
"$PYTHON" -m py_compile \
  ...
  scripts/benchmark/serving/serve_trace_net_nha_phase20_gemma100_v1.py \
  scripts/benchmark/graph/run_trace_net_nha_phase20_gemma100_v1.py \
  scripts/benchmark/graph/check_trace_net_nha_phase20_gemma100_v1.py
...
exec "$PYTHON" -u -B scripts/benchmark/serving/serve_trace_net_nha_phase20_gemma100_v1.py \\
  --host 127.0.0.1 \\
  --port "$BENCHMARK_PORT" \\
...
"$PYTHON" -B scripts/benchmark/graph/run_trace_net_nha_phase20_gemma100_v1.py \
...
"$PYTHON" -B scripts/benchmark/graph/check_trace_net_nha_phase20_gemma100_v1.py \
  --output-dir "$RUN_ROOT/gemma100" \
  --strict
