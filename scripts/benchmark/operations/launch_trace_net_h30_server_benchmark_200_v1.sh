...
"$PYTHON" -B -m py_compile \
  src/trace_net/validation/trace_net_h30_answer_boundary_v1.py \
  scripts/operations/s6_retrieval/serve_trace_net_cognitive_router_v1.py \
  scripts/benchmark/validation/run_trace_net_h30_server_benchmark_200_v1.py \
...
set +e
"$PYTHON" -B scripts/benchmark/validation/run_trace_net_h30_server_benchmark_200_v1.py \
  --base-url "$BASE_URL" \
  --api-key "$API_KEY" \
