...
REPO = ROOT.parent
FILES = [
    (ROOT / "scripts/operations/router/serve_trace_net_guided_discovery_router_proxy_v1.py", REPO / "scripts/operations/router/serve_trace_net_guided_discovery_router_proxy_v1.py"),
