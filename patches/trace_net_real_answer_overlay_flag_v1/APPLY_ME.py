...
PATCH_NAME = "trace_net_real_answer_overlay_flag_v1"
ROOT = Path.cwd()

FILES = {}

FILES["tiff/trace_net_engineering_real_answer_smoke_overlay_flag_v1.py"] = r'''from __future__ import annotations
...
FILES["tests/unit/test_trace_net_engineering_real_answer_smoke_overlay_flag_v1.py"] = r'''from __future__ import annotations
...
FILES["docs/trace_net_engineering_real_answer_smoke_overlay_flag_v1_README.md"] = r'''# TRACE-Net Real Answer Smoke Engram Overlay Flag v1
