...
for rel in ["scripts/audit_trace_net_image_route_nonredundancy_v1.py","tests/unit/test_trace_net_image_route_nonredundancy_audit_v1.py","docs/trace_net_image_route_nonredundancy_audit_v1_README.md"]:
