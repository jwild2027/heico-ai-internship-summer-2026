...
FILES = [
    (PATCH_DIR / "scripts/benchmark/run_trace_net_router_exact_normal_ask_smoke_v1.py", ROOT / "scripts/benchmark/run_trace_net_router_exact_normal_ask_smoke_v1.py"),
