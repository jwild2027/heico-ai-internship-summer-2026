...
MODULE_PATH = Path("scripts/operations/router/launch_trace_net_router_stack_v3.py")
...
def test_launcher_v3_uses_router_proxy_v5_script():
    assert launcher.ROUTER_SCRIPT.as_posix() == "scripts/operations/router/serve_trace_net_guided_discovery_router_proxy_v5.py"
