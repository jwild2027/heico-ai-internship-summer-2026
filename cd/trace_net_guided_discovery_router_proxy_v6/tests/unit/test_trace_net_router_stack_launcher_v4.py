...
MODULE_PATH = Path("scripts/operations/router/launch_trace_net_router_stack_v4.py")
...
def test_launcher_v4_uses_router_proxy_v6_script():
    assert launcher.ROUTER_SCRIPT.as_posix() == "scripts/operations/router/serve_trace_net_guided_discovery_router_proxy_v6.py"
