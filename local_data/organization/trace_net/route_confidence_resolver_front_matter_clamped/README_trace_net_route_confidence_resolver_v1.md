...
- **auto_resolved_route_count**: `169`
- **can_answer_directly_count**: `0`
- **can_prove_claims_count**: `0`
- **canonical_route_label_count**: `9`
- **do_not_embed_count**: `354`
...
- **multi_route_required_count**: `82`
- **opensearch_index_allowed_count**: `144`
- **opensearch_write_attempt_count**: `0`
- **postgres_write_attempt_count**: `0`
- **primary_route_counts**: `{'blank_candidate': 14, 'cover_or_title_page': 1, 'detailed_parts_list': 251, 'image_visual_diagram': 151, 'mixed_text_and_figure': 10, 'normal_text': 12, 'procedure_or_description': 24, 'review_required': 12, 'table_or_index': 34}`
- **qdrant_embedding_allowed_count**: `155`
- **qdrant_write_attempt_count**: `0`
- **ready_for_multi_route_processing**: `True`
- **ready_for_validator_gated_storage**: `True`
- **resolver_record_count**: `509`
- **route_confidence_band_counts**: `{'high': 169, 'low': 49, 'medium': 291}`
