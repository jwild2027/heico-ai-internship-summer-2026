...
- correction_record_count: `44`
- safe_action_record_count: `44`
...
This artifact is read-only and retrieval-only. It cannot answer directly, prove claims, write to stores, or mutate source truth.
