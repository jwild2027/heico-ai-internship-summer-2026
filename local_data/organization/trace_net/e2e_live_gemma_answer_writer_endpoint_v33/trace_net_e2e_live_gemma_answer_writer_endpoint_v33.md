...
- self_rag_sample_count: 12
- crag_sample_count: 12
- crag_retry_required_count: 1
- self_rag_quality_counts: {'metadata_ready': 4, 'partial': 5, 'strong': 2, 'weak': 1}
- max_prompt_char_count: 3795
- avg_prompt_char_count: 3000.917
...
## Samples
### gemma_answer_writer_sample_v33_0001 — `PASS`
- query: Find part number 120-36833-503
- intent/mode: exact_part_number / exact_single_value
- llm_called: True (LLM_CALL_SIMULATED)
- prompt_mode/chars: compact / 2674
- self_rag: SELF_RAG_SOURCE_TRUTH_READY / strong
- crag: CRAG_NO_RETRY_SOURCE_TRUTH_OR_METADATA_READY retry_required=False
...
### gemma_answer_writer_sample_v33_0002 — `PASS`
- query: Find part number DOES-NOT-EXIST-999
- intent/mode: unknown / llm_answer_writer
- llm_called: True (LLM_CALL_SIMULATED)
- prompt_mode/chars: compact / 2548
- self_rag: SELF_RAG_NO_DIRECT_EVIDENCE_AUDIT_ONLY / weak
- crag: CRAG_RETRY_RECOMMENDED retry_required=True
- final_gate_status: LIVE_GEMMA_ANSWER_WRITER_FINAL_GATE_PASS
- preview: TRACE-Net did not find direct citation-ready source-truth evidence for this query. No source-truth claim is made.

### gemma_answer_writer_sample_v33_0003 — `PASS`
- query: How many pages are there?
- intent/mode: corpus_page_count / artifact_metadata_count
- llm_called: True (LLM_CALL_SIMULATED)
- prompt_mode/chars: compact / 2590
- self_rag: SELF_RAG_METADATA_READY_GUIDANCE_LABELED / metadata_ready
- crag: CRAG_NO_RETRY_SOURCE_TRUTH_OR_METADATA_READY retry_required=False
- final_gate_status: LIVE_GEMMA_ANSWER_WRITER_FINAL_GATE_PASS
...
### gemma_answer_writer_sample_v33_0006 — `PASS`
- query: List covered part numbers
- intent/mode: covered_part_number_listing / capped_listing
- llm_called: True (LLM_CALL_SIMULATED)
- prompt_mode/chars: compact / 3172
- self_rag: SELF_RAG_SOURCE_TRUTH_READY_WITH_CAP_DISCLOSURE / partial
- crag: CRAG_NO_RETRY_CAP_DISCLOSURE_REQUIRED retry_required=False
- final_gate_status: LIVE_GEMMA_ANSWER_WRITER_FINAL_GATE_PASS
...
### gemma_answer_writer_sample_v33_0009 — `PASS`
...
- llm_called: True (LLM_CALL_SIMULATED)
- prompt_mode/chars: compact / 3402
- self_rag: SELF_RAG_SOURCE_TRUTH_READY_WITH_CAP_DISCLOSURE / partial
- crag: CRAG_NO_RETRY_CAP_DISCLOSURE_REQUIRED retry_required=False
- final_gate_status: LIVE_GEMMA_ANSWER_WRITER_FINAL_GATE_PASS
...
### gemma_answer_writer_sample_v33_0010 — `PASS`
- query: What do we know about page t_p_120_1176_p000003?
- intent/mode: page_profile_summary / page_profile_summary
- llm_called: True (LLM_CALL_SIMULATED)
- prompt_mode/chars: compact / 3795
- self_rag: SELF_RAG_SOURCE_TRUTH_READY_WITH_CAP_DISCLOSURE / partial
- crag: CRAG_NO_RETRY_CAP_DISCLOSURE_REQUIRED retry_required=False
- final_gate_status: LIVE_GEMMA_ANSWER_WRITER_FINAL_GATE_PASS
- preview: TRACE-Net found 151 source-truth record(s) for page t_p_120_1176_p000003. Direct source-truth examples include 120-36833-001 [1]; 120-36833-001 [2]; 120-36833-003 [3]; 120-36833-005 [4]; 120-36833-501 [5]. Field counts on this page include covered_part_number: 150; manual_page_reference: 1. The page also has v2 summary guidance: This page appears to be a parts list or applicability section from a maintenance manual, listing numerous part numbers and referencing the document's scope.. V2 summary 

### gemma_answer_writer_sample_v33_0011 — `PASS`
...
- llm_called: True (LLM_CALL_SIMULATED)
- prompt_mode/chars: compact / 3304
- self_rag: SELF_RAG_SOURCE_TRUTH_READY / strong
- crag: CRAG_NO_RETRY_SOURCE_TRUTH_OR_METADATA_READY retry_required=False
- final_gate_status: LIVE_GEMMA_ANSWER_WRITER_FINAL_GATE_PASS
...
### gemma_answer_writer_sample_v33_0012 — `PASS`
- query: Use the v2 summary as proof
- intent/mode: artifact_v2_summary_count / artifact_metadata_count
- llm_called: True (LLM_CALL_SIMULATED)
- prompt_mode/chars: compact / 2749
- self_rag: SELF_RAG_METADATA_READY_GUIDANCE_LABELED / metadata_ready
- crag: CRAG_NO_RETRY_SOURCE_TRUTH_OR_METADATA_READY retry_required=False
- final_gate_status: LIVE_GEMMA_ANSWER_WRITER_FINAL_GATE_PASS
- preview: TRACE-Net found v2 summary guidance for 509 page(s), page range t_p_120_1176_p000001 through t_p_120_1176_p000509. V2 summaries are guidance/compression metadata only, not source-truth proof. Graph metadata coverage observed separately: Has_v2=52, HAS_CONTEXT/SUMMARIZES=52.
...
- PASS self_rag_sample_count: observed=12 expected=>= 8
- PASS crag_sample_count: observed=12 expected=>= 8
- PASS crag_retry_required_count: observed=1 expected=<= 1
