...
- Used tools: `['query_planner', 'context_pack_blueprint', 'context_pack_builder', 'self_rag', 'route_dispatch', 'table_route', 'page_context_v2', 'graph_leiden']`
...
visual/image/route: input_missing — configured path for image_visual_observer does not exist
