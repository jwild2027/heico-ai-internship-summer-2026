...
def default_user_query_cases(include_slow: bool = False) -> list[UserQueryCase]:
    cases = [
        UserQueryCase(
            ...
            command=["scripts/query_document_organization.py", "--part", "120-37313-001", "--strict"],
        ...
        UserQueryCase(
            ...
            command=["scripts/query_document_organization.py", "--part", "AM03078-22", "--strict"],
        ...
        UserQueryCase(
            ...
            command=["scripts/query_document_organization.py", "--ata", "25-21-00", "--strict"],
        ...
        UserQueryCase(
            ...
            command=["scripts/query_document_organization.py", "--page", "t_p_120_1176_p000042", "--strict"],
        ...
        UserQueryCase(
            ...
            command=["scripts/test_document_graph_traversal.py", "--part", "120-37313-001", "--strict"],
        ...
        UserQueryCase(
            ...
            command=["scripts/inspect_page_contexts.py", "--page", "t_p_120_1176_p000042", "--limit", "5"],
        ...
        UserQueryCase(
            ...
            command=["scripts/ask_tiff_rag.py", "--config", "{config}", "What is part number 120-37313-001?"],
        ...
        UserQueryCase(
            ...
            command=["scripts/ask_tiff_rag.py", "--config", "{config}", "What is part number AM03078-22?"],
        ...
        UserQueryCase(
            ...
            command=["scripts/ask_tiff_rag.py", "--config", "{config}", "Where is HOLDER, MAGAZINE mentioned?"],
        ...
        UserQueryCase(
            ...
            command=["scripts/ask_tiff_rag.py", "--config", "{config}", "Find evidence for ATA 25-21-00."],
