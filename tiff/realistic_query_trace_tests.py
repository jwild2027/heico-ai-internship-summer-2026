    ...
    cases = [
        RealisticTraceCase(
            ...
            checks=(
                ...
                CommandCheck(
                    ...
                    command=("scripts/trace_document_graph.py", "--part", "120-37313-001", "--strict"),
                    expected_contains=(
        ...
        RealisticTraceCase(
            ...
            checks=(
                ...
                CommandCheck(
                    label="graph_part_trace",
                    command=("scripts/trace_document_graph.py", "--part", "AM03078-22", "--strict"),
        ...
        RealisticTraceCase(
            ...
            checks=(
                CommandCheck(
                    ...
                    command=("scripts/ask_tiff_rag.py", "--config", "{config}", "Find evidence for ATA 25-21-00 and show source pages."),
                ...
                CommandCheck(
                    ...
                    command=("scripts/trace_document_graph.py", "--ata", "25-21-00", "--max-pages", "8", "--strict"),
        ...
        RealisticTraceCase(
            ...
            checks=(
                CommandCheck(
                    ...
                    command=("scripts/trace_document_graph.py", "--page", "t_p_120_1176_p000083", "--strict"),
                    expected_contains=(
                        "Trace: page_trace",
                        "Status: OK",
        ...
        RealisticTraceCase(
            ...
            checks=(
                CommandCheck(
                    ...
                    command=(
                        "scripts/trace_document_graph.py",
                        "--vector-page",
        ...
        RealisticTraceCase(
            ...
            checks=(
                CommandCheck(
                    ...
                    command=("scripts/inspect_page_contexts.py", "--page", "t_p_120_1176_p000495", "--limit", "5"),
