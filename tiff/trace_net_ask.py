...
class AskOptions:
    ...
    search_script: Path = Path("scripts/search_trace_net_rag_candidates.py")
    citations_script: Path = Path("scripts/build_trace_net_source_citations.py")
    group_script: Path = Path("scripts/group_trace_net_search_results.py")
    answer_script: Path = Path("scripts/compose_trace_net_answer.py")
    feedback_search_sim_script: Path = Path("scripts/simulate_trace_net_feedback_search.py")
    feedback_ask_sim_script: Path = Path("scripts/simulate_trace_net_feedback_ask.py")
