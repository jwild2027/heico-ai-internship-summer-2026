"""Compatibility shim (tiff reorganization). Moved to ``tests/integration/api_contract_tests.py``.
...
_target = _P(__file__).resolve().parent.parent / "tests/integration/api_contract_tests.py"
