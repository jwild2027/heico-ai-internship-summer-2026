"""Compatibility shim (tiff reorganization). Moved to ``tests/regression/trace_net_regression_eval_v1.py``.
...
_target = _P(__file__).resolve().parent.parent / "tests/regression/trace_net_regression_eval_v1.py"
