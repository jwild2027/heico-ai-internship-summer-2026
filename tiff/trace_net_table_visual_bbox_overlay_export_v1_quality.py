"""Quality checker for TRACE-Net Table Visual BBox Overlay Export v1."""
...
from tiff.trace_net_table_visual_bbox_overlay_export_v1 import QUALITY_SCHEMA_VERSION, quality_errors, utc_now, write_json
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Check TRACE-Net table visual bbox overlay export v1 quality")
...
def check_report(args: argparse.Namespace) -> dict[str, Any]:
    ...
    if args.write_json:
        write_json(report_path.with_name("trace_net_table_visual_bbox_overlay_export_v1_quality.json"), quality_payload)
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    print("TRACE-Net Table Visual BBox Overlay Export v1 quality")
