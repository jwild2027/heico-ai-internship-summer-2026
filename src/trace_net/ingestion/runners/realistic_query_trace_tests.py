    ...
    cases = [
        RealisticTraceCase(
            ...
            checks=(
                ...
                CommandCheck(
                    ...
                    command=("scripts/maintenance/s3_graph_store/trace_document_graph.py", "--part", "120-37313-001", "--strict"),
                    expected_contains=(
        ...
        RealisticTraceCase(
            ...
            checks=(
                ...
                CommandCheck(
                    label="graph_part_trace",
                    command=("scripts/maintenance/s3_graph_store/trace_document_graph.py", "--part", "AM03078-22", "--strict"),
        ...
        RealisticTraceCase(
            ...
            checks=(
                ...
                CommandCheck(
                    ...
                    command=("scripts/maintenance/s3_graph_store/trace_document_graph.py", "--ata", "25-21-00", "--max-pages", "8", "--strict"),
        ...
        RealisticTraceCase(
            ...
            checks=(
                CommandCheck(
                    ...
                    command=("scripts/maintenance/s3_graph_store/trace_document_graph.py", "--page", "t_p_120_1176_p000083", "--strict"),
                    expected_contains=(
                        "Trace: page_trace",
                        "Status: OK",
        ...
        RealisticTraceCase(
            ...
            checks=(
                CommandCheck(
                    ...
                    command=(
                        "scripts/maintenance/s3_graph_store/trace_document_graph.py",
                        "--vector-page",
        ...
        RealisticTraceCase(
            ...
            checks=(
                CommandCheck(
                    ...
                    command=("scripts/maintenance/s6_retrieval/inspect_page_contexts.py", "--page", "t_p_120_1176_p000495", "--limit", "5"),
