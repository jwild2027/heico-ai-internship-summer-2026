...
Embeddings are not created here; ``scripts/build/embeddings/build_rag_embeddings.py`` should run
...
def run_changed_page_backend_update(
    *,
    ...
    This does not call Ollama.  Run ``scripts/build/embeddings/build_rag_embeddings.py`` after
