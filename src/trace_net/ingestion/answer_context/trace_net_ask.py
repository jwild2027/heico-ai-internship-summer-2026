...
class AskOptions:
    ...
    search_script: Path = Path("scripts/operations/embeddings/search_trace_net_rag_candidates.py")
    ...
    answer_script: Path = Path("scripts/operations/ingestion/compose_trace_net_answer.py")
    feedback_search_sim_script: Path = Path("scripts/operations/feedback/simulate_trace_net_feedback_search.py")
