...
from tiff.incremental_state import (
...
def build_commands(
    ...
    *,
    ...
    ocr_argv = [
        sys.executable,
        "src/trace_net/ingestion/batch_scan_tiffs_to_json.py",
        "--input-dir",
        cfg.tiff_root,
        "--input-list",
        cfg.changed_list,
    ...
    if backend_mode in {"changed-pages", "changed_page", "changed_page_update", "incremental"} and summary.changed_list_count > 0:
        backend_argv = [
            sys.executable,
            "scripts/operations/ingestion/update_changed_page_backend.py",
            "--config",
        ...
        backend_argv = [
            sys.executable,
            "scripts/operations/ingestion/run_tiff_backend_pipeline.py",
            "--config",
            cfg.config_path or "local_config.yaml",
            "--db-path",
            cfg.db_path,
