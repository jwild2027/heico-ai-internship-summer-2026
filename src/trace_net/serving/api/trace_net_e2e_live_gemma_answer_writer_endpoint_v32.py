...
VERSION = "v32"
MODULE = "trace_net_e2e_live_gemma_answer_writer_endpoint_v32"
MODEL_ID = "trace-net-e2e-live-gemma-answer-writer-v32"
...
def _compact_llm_content(package: Mapping[str, Any], *, max_evidence: int = 5) -> Dict[str, Any]:
    ...
    content: Dict[str, Any] = {
        ...
        "normal_intent_package": package.get("query_intent") in NORMAL_INTENTS_V32_2,
...
class TraceNetGemmaAnswerWriterV32:
    def __init__(self, artifacts: TraceNetArtifactsV32):
        self.artifacts = artifacts

    @classmethod
    def from_paths(cls, **kwargs: Any) -> "TraceNetGemmaAnswerWriterV32":
        return cls(TraceNetArtifactsV32.load(**kwargs))
    ...
    def build_package(self, query: str, *, max_evidence: int = 10) -> Dict[str, Any]:
        ...
        package: Dict[str, Any] = {
            "package_id": _stable_id("tracenet_package_v32", q),
            "user_query": q,
            "query_intent": intent,
    ...
    def answer_query(
        ...
        *,
        ...
        guidance = package.get("graph_guidance", {}) or {}
        return {
            "id": "chatcmpl-tracenet-v32-" + uuid.uuid4().hex[:16],
            ...
            "trace_net": {
                "endpoint_version": "live_gemma_answer_writer_v32",
                "query_intent": package.get("query_intent"),
                "response_mode": package.get("response_mode"),
...
def build_report(
    *,
    ...
    for q in demo_queries:
        ...
        samples.append(
            {
                "sample_id": f"gemma_answer_writer_sample_v32_{len(samples)+1:04d}",
                "user_query": q,
                ...
                "normal_intent_package": tn.get("query_intent") in NORMAL_INTENTS_V32_2,
    ...
    report_path = out / "trace_net_e2e_live_gemma_answer_writer_endpoint_v32.json"
    samples_path = out / "trace_net_e2e_live_gemma_answer_writer_endpoint_samples_v32.jsonl"
    md_path = out / "trace_net_e2e_live_gemma_answer_writer_endpoint_v32.md"
...
def main_build(argv: Optional[Sequence[str]] = None) -> int:
    ...
    print("TRACE-Net E2E Live Gemma Answer Writer Endpoint v32")
    print(" Status:", report["status"])
    print(" Quality status:", report["quality_status"])
    for k in ("sample_query_count", "sample_success_count", "llm_called_sample_count", "compact_prompt_sample_count", "normal_intent_sample_count", "max_prompt_char_count", "post_gate_issue_count", "page_context_v2_page_count", "nomenclature_page_count", "base_url_windows", "base_url_open_webui_docker", "report_path"):
