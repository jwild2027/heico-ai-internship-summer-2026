...
from src.trace_net.ocr.trace_net_h30_layout_aware_ocr_v1 import (
...
try:
    from src.trace_net.graph.trace_net_h30_graph_source_retrieval_v1 import load_graph_index
except Exception:  # pragma: no cover - defensive
