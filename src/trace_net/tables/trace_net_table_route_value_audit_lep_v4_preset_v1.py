...
BUILD_SCRIPT = Path("scripts/build/tables/build_trace_net_table_route_value_audit_v1.py")
CHECK_SCRIPT = Path("scripts/maintenance/tables/check_trace_net_table_route_value_audit_v1_quality.py")
