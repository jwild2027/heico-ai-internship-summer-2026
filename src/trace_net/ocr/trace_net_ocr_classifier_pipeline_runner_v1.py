...
def _build_command_plan(
    *,
    ...
    add(
        ...
        "check",
        [
            "scripts/maintenance/benchmark/check_trace_net_four_route_operational_resolver_v1_quality.py",
            "--report-path",
    ...
    add(
        ...
        "check",
        [
            "scripts/maintenance/benchmark/check_trace_net_route_validator_runner_v1_quality.py",
            "--report-path",
    ...
    add(
        ...
        "check",
        [
            "scripts/maintenance/benchmark/check_trace_net_route_unresolved_retry_probe_v1_quality.py",
            "--report-path",
            str(reports["retry"]),
            "--write-json",
            "--min-records",
    ...
    add(
        ...
        "check",
        [
            "scripts/maintenance/benchmark/check_trace_net_four_route_storage_gate_v1_quality.py",
            "--report-path",
            str(reports["storage"]),
            "--write-json",
            "--min-records",
    ...
    add(
        ...
        "check",
        [
            "scripts/maintenance/benchmark/check_trace_net_dry_run_loader_planner_v1_quality.py",
            "--report-path",
            str(reports["loader"]),
            "--write-json",
            "--min-records",
    ...
    add(
        ...
        "build",
        [
            "scripts/benchmark/build_trace_net_retrieval_payload_audit_v1.py",
    ...
    add(
        ...
        "check",
        [
            "scripts/benchmark/check_trace_net_retrieval_payload_audit_v1_quality.py",
            "--report-path",
