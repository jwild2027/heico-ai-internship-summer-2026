...
def test_build_script_importable() -> None:
    path = Path("scripts/build/ingestion/build_trace_net_e2e_rag_demo_report_v1.py")
...
def test_check_script_importable() -> None:
    path = Path("scripts/maintenance/validation/check_trace_net_e2e_rag_demo_report_v1_quality.py")
