...
def test_build_script_imports():
    path = Path("scripts/run_trace_net_raw_to_answer_context_engineered_native_v1.py")
    assert path.exists()
...
def test_check_script_imports():
    path = Path("scripts/check_trace_net_raw_to_answer_context_engineered_native_v1_quality.py")
    assert path.exists()
