...
def test_lineage_guard_scripts_help() -> None:
    for script in (
        "scripts/build/retrieval/build_trace_net_opensearch_adapter_lineage_rebuild_v1.py",
        "scripts/maintenance/s6_retrieval/check_trace_net_opensearch_adapter_lineage_guard_v1_quality.py",
    ):
