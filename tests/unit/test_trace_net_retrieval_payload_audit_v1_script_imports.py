...
def test_build_script_imports():
    path = Path("scripts/benchmark/build_trace_net_retrieval_payload_audit_v1.py")
    assert path.exists()
...
def test_check_script_imports():
    path = Path("scripts/benchmark/check_trace_net_retrieval_payload_audit_v1_quality.py")
    assert path.exists()
