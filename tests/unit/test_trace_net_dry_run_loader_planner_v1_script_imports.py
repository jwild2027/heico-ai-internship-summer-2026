...
def test_build_script_imports() -> None:
    path = Path("scripts/build/operations/build_trace_net_dry_run_loader_planner_v1.py")
...
def test_check_script_imports() -> None:
    path = Path("scripts/maintenance/benchmark/check_trace_net_dry_run_loader_planner_v1_quality.py")
