...
def test_smoke_script_imports() -> None:
    path = Path("scripts/benchmark/s3_graph_store/smoke_trace_net_synthetic_incident_postgres_v1.py")
...
def test_quality_script_imports() -> None:
    path = Path("scripts/benchmark/s3_graph_store/check_trace_net_synthetic_incident_postgres_smoke_v1_quality.py")
