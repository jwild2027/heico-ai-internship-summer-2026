...
def test_build_script_importable():
    path = Path("scripts/build/ingestion/build_trace_net_page_query_response_source_cross_reference_v1.py")
...
def test_check_script_importable():
    path = Path("scripts/maintenance/s6_retrieval/check_trace_net_page_query_response_source_cross_reference_v1_quality.py")
