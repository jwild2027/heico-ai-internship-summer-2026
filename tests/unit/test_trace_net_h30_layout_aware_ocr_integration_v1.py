...
def test_answer_quality_reconstructs_q17_without_blur_claim():
    quality = load("scripts/trace_net_h30_answer_quality_v1.py", "layout_quality_integration")
    registry = [{
        "citation_id": 1,
        "class": "semantic",
...
def test_page_bridge_attaches_and_prompts_layout_reconstruction():
    bridge = load("scripts/trace_net_h30_page_content_bridge_v1.py", "layout_bridge_integration")
    raw = {
        "page_id": "t_p_120_1176_p000005",
...
def test_existing_answer_quality_contract_still_loads():
    quality = load("scripts/trace_net_h30_answer_quality_v1.py", "layout_quality_load")
