...
def test_build_script_imports() -> None:
    path = Path("scripts/build/ocr/build_trace_net_fishnet_router_hardening_policy_v1.py")
...
def test_check_script_imports() -> None:
    path = Path("scripts/maintenance/benchmark/check_trace_net_fishnet_router_hardening_policy_v1_quality.py")
