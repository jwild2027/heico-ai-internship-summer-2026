...
COGNITIVE_PATH = Path("scripts/operations/s6_retrieval/serve_trace_net_cognitive_router_v1.py")
GEMMA_PATH = Path("scripts/operations/writing/serve_trace_net_full_gemma_cognitive_v1.py")
