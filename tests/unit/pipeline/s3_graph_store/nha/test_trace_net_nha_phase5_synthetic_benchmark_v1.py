...
def test_end_to_end_build_and_cli_entrypoints(tmp_path):
    ...
    for relative in (
        "scripts/benchmark/s3_graph_store/build_trace_net_nha_phase5_synthetic_benchmark_v1.py",
        "scripts/benchmark/s3_graph_store/check_trace_net_nha_phase5_synthetic_benchmark_v1.py",
    ):
