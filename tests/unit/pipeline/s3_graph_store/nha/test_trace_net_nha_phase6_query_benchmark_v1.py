...
def test_cli_entrypoints_bootstrap_repo_root(tmp_path):
    ...
    for relative in (
        "scripts/benchmark/s3_graph_store/run_trace_net_nha_phase6_query_benchmark_v1.py",
        "scripts/benchmark/s3_graph_store/check_trace_net_nha_phase6_query_benchmark_v1.py",
    ):
