...
_grounded_stub = types.ModuleType("scripts.benchmark.s3_graph_store.run_trace_net_tiff_grounded20_v1")
...
sys.modules.setdefault("scripts.benchmark.s3_graph_store.run_trace_net_tiff_grounded20_v1", _grounded_stub)
