...
def test_build_script_imports():
    path = Path("scripts/build/tables/build_trace_net_table_structure_bbox_localizer_v1.py")
...
def test_check_script_imports():
    path = Path("scripts/maintenance/benchmark/check_trace_net_table_structure_bbox_localizer_v1_quality.py")
