...
def test_build_script_imports():
    path = Path("scripts/build/ingestion/build_trace_net_e2e_reasoned_response_draft_v12.py")
...
def test_check_script_imports():
    path = Path("scripts/maintenance/validation/check_trace_net_e2e_reasoned_response_draft_v12_quality.py")
