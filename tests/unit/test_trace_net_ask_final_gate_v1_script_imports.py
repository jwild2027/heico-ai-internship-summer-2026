...
def test_run_script_imports() -> None:
    path = Path("scripts/benchmark/validation/run_trace_net_ask_final_gate_v1.py")
...
def test_quality_script_imports() -> None:
    path = Path("scripts/benchmark/validation/check_trace_net_ask_final_gate_v1_quality.py")
