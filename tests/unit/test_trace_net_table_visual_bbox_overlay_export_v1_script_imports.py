...
def test_script_modules_import() -> None:
    assert importlib.import_module("scripts.build_trace_net_table_visual_bbox_overlay_export_v1")
    assert importlib.import_module("scripts.check_trace_net_table_visual_bbox_overlay_export_v1_quality")
