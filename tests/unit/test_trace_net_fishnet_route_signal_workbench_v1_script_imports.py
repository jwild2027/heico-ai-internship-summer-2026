...
def test_build_script_imports():
    path = Path("scripts/build/ocr/build_trace_net_fishnet_route_signal_workbench_v1.py")
    assert path.exists()
...
def test_quality_script_imports():
    path = Path("scripts/maintenance/benchmark/check_trace_net_fishnet_route_signal_workbench_v1_quality.py")
    assert path.exists()
