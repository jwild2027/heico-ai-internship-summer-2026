...
def test_run_script_imports() -> None:
    path = Path("scripts/benchmark/run_trace_net_community_aware_retrieval_sim_v1.py")
...
def test_check_script_imports() -> None:
    path = Path("scripts/benchmark/check_trace_net_community_aware_retrieval_sim_v1_quality.py")
