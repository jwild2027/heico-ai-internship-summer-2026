...
def test_script_imports() -> None:
    ...
    import scripts.maintenance.s2_ocr.check_trace_net_table_line_geometry_v1_quality as check_script
...
def test_scripts_help_from_repo_root() -> None:
    ...
    for script in (
        ...
        "scripts/maintenance/s2_ocr/check_trace_net_table_line_geometry_v1_quality.py",
    ):
