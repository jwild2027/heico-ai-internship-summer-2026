...
def test_script_imports() -> None:
    ...
    scripts = [
        ...
        root / "scripts/maintenance/s6_retrieval/check_trace_net_opensearch_live_loader_v1_quality.py",
        root / "scripts/operations/s6_retrieval/run_trace_net_opensearch_live_loader_v1.py",
    ]
