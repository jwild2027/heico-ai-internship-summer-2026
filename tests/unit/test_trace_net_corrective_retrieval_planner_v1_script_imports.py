...
def test_build_script_importable():
    path = Path("scripts/benchmark/build_trace_net_corrective_retrieval_planner_v1.py")
...
def test_check_script_importable():
    path = Path("scripts/benchmark/check_trace_net_corrective_retrieval_planner_v1_quality.py")
