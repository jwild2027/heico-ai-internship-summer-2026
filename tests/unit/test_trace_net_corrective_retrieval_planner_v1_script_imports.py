...
def test_build_script_importable():
    path = Path("scripts/benchmark/s6_retrieval/build_trace_net_corrective_retrieval_planner_v1.py")
...
def test_check_script_importable():
    path = Path("scripts/benchmark/s6_retrieval/check_trace_net_corrective_retrieval_planner_v1_quality.py")
