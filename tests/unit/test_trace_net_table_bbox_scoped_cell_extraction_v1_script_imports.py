...
def test_build_script_imports():
    path = Path("scripts/build_trace_net_table_bbox_scoped_cell_extraction_v1.py")
    assert path.exists()
...
def test_check_script_imports():
    path = Path("scripts/check_trace_net_table_bbox_scoped_cell_extraction_v1_quality.py")
    assert path.exists()
