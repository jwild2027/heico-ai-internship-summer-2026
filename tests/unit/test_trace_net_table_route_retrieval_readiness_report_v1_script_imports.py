...
def test_build_script_imports() -> None:
    path = ROOT / "scripts/benchmark/s2_ocr/build_trace_net_table_route_retrieval_readiness_report_v1.py"
...
def test_check_script_imports() -> None:
    path = ROOT / "scripts/benchmark/s2_ocr/check_trace_net_table_route_retrieval_readiness_report_v1_quality.py"
