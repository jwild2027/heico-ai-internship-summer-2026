...
def test_build_script_imports():
    path = Path("scripts/benchmark/serving/build_trace_net_e2e_api_wrapper_smoke_v1.py")
...
def test_check_script_imports():
    path = Path("scripts/benchmark/serving/check_trace_net_e2e_api_wrapper_smoke_v1_quality.py")
