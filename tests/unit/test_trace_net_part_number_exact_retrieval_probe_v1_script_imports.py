...
def test_build_script_imports():
    path = Path("scripts/benchmark/s6_retrieval/build_trace_net_part_number_exact_retrieval_probe_v1.py")
    assert path.exists()
...
def test_check_script_imports():
    path = Path("scripts/benchmark/s6_retrieval/check_trace_net_part_number_exact_retrieval_probe_v1_quality.py")
    assert path.exists()
