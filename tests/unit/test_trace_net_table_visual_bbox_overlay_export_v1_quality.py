...
from tiff.trace_net_table_visual_bbox_overlay_export_v1 import quality_errors
...
def test_quality_errors_pass_for_safe_overlay_summary() -> None:
    summary = {
        ...
        "unsafe_table_visual_bbox_overlay_record_count": 0,
...
def test_quality_errors_fail_on_missing_overlays_and_unsafe_counts() -> None:
    summary = {
        "source_table_visual_bbox_localizer_quality_status": "FAIL",
        ...
        "unsafe_table_visual_bbox_overlay_record_count": 1,
    ...
    assert "source_table_visual_bbox_localizer_quality_status_not_pass" in errors
    assert "overlay_png_written_count_below_min" in errors
    assert "unsafe_table_visual_bbox_overlay_record_count_above_max" in errors
