...
def test_no_duplicated_function_headers():
    ...
    guided = (root / "scripts/operations/retrieval/run_trace_net_guided_candidate_discovery_v4.py").read_text(encoding="utf-8")
    wrapper = (root / "scripts/benchmark/serving/serve_trace_net_full_gemma_user_query_canary_v1.py").read_text(encoding="utf-8")
