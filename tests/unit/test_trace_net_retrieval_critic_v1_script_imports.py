...
def test_build_script_imports():
    path = Path("scripts/benchmark/validation/build_trace_net_retrieval_critic_v1.py")
...
def test_check_script_imports():
    path = Path("scripts/benchmark/validation/check_trace_net_retrieval_critic_v1_quality.py")
