...
def test_run_script_imports() -> None:
    path = Path("scripts/benchmark/serving/run_trace_net_ask_api_dynamic_retrieval_v2.py")
...
def test_quality_script_imports() -> None:
    path = Path("scripts/benchmark/serving/check_trace_net_ask_api_dynamic_retrieval_v2_quality.py")
